...
<head>
	...
	<link rel="stylesheet" href="<c:url value="/resources/css/fonts/linecons/css/linecons.css" />">
	<link rel="stylesheet" href="<c:url value="/resources/css/fonts/fontawesome/css/font-awesome.min.css" />">
	<link rel="stylesheet" href="<c:url value="/resources/css/bootstrap.css" />">
	<link rel="stylesheet" href="<c:url value="/resources/css/xenon-core.css" />">
	<link rel="stylesheet" href="<c:url value="/resources/css/xenon-forms.css" />">
	<link rel="stylesheet" href="<c:url value="/resources/css/xenon-components.css" />">
	<link rel="stylesheet" href="<c:url value="/resources/css/xenon-skins.css" />">
...
<body class="page-body">
	...
	<script src="<c:url value="/resources/js/resizeable.js" />"></script>
	<script src="<c:url value="/resources/js/joinable.js" />"></script>
	<script src="<c:url value="/resources/js/xenon-api.js" />"></script>
	<script src="<c:url value="/resources/js/xenon-toggles.js" />"></script>
	<script src="<c:url value="/resources/js/jquery-validate/jquery.validate.min.js" />"></script>
	<script src="<c:url value="/resources/js/toastr/toastr.min.js" />"></script>


	<!-- JavaScripts initializations and stuff -->
	<script src="<c:url value="/resources/js/xenon-custom.js" />"></script>
